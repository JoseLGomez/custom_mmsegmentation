    ...
    with ExitStack() as stack:
        ...
        with open(images_txt,'w') as f:
            for idx, inputs in enumerate(data_loader):
                ...
                if evaluation:
                    evaluator.process(inputs, torch.unsqueeze(ensemble, 0), ensemble=True)
        ...
        if cfg.SOLVER.ALTERNATE_SOURCE_PSEUDOLABELS and dataset_pseudolabels is not None \
            ...
            if cfg.SOLVER.ALTERNATE_SOURCE_PSEUDOLABELS and dataset_pseudolabels is not None \
                ...
                if cfg.SOLVER.ACTIVATE_CLASSMIX:
                    ...
                    data_loader = build_detection_train_loader(cfg, dataset=dataset_pseudo, mapper=mapper_pseudo,
