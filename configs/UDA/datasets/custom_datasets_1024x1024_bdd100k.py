...
custom_datasetB = dict(
    type='SynscapesDataset',
    img_dir='/datafast/118-1/Datasets/segmentation/Synscapes/img/rgb_translated_BDD10K_subset.txt',
...
custom_datasetC = dict(
    ...
    img_dir='/datafast/118-1/Datasets/segmentation/GTA/gta5_rgb_translated_bdd100k_subset.txt',
    ann_dir='/datafast/118-1/Datasets/segmentation/GTA/gta5_gt_full.txt',
    mode_txt=True,
    pipeline=train_pipeline)

custom_datasetD = dict(
    type='SynscapesDataset',
    #data_root='data/synscapes/',
    img_dir='/datafast/118-1/Datasets/segmentation/new_synthetic_dataset/data_splits/gta5+Sysncapes_images_translated_filtered_bdd.txt',
